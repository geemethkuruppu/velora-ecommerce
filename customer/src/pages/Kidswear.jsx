...
import heroImage from '../assets/images/kidswear.jpg';
...
const Kidswear = () => {
    ...
    const fetchProducts = async (categoryId = null) => {
        try {
            ...
            console.error('Failed to fetch kidswear products:', error);
        } finally {
            setLoading(false);
        }
    };
            ...
            <div className="py-16 px-6 md:px-12 max-w-7xl mx-auto min-h-[400px]">
                ...
                >
                    <h2 className="text-3xl md:text-4xl font-serif text-gray-900 tracking-wider mb-4">
                        {selectedCategory ? 'Category Collection' : 'Little Ones'}
                    </h2>
                    <p className="text-gray-600 text-lg">
                        {loading ? 'Refreshing collection...' : 'Stylish comfort for every adventure'}
                    </p>
                </motion.div>
