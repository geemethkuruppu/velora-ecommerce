...
import heroImage from '../assets/images/menswear.jpg';
...
const Menswear = () => {
    ...
    const fetchProducts = async (categoryId = null) => {
        try {
            ...
            console.error('Failed to fetch menswear products:', error);
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div className="min-h-screen bg-[#b3c0df]">
            ...
            <div className="py-16 px-6 md:px-12 max-w-7xl mx-auto min-h-[400px]">
                ...
                >
                    <h2 className="text-3xl md:text-4xl font-serif text-gray-900 tracking-wider mb-4">
                        {selectedCategory ? 'Category Collection' : "Gentleman's Collection"}
                    </h2>
                    <p className="text-gray-600 text-lg">
                        {loading ? 'Refreshing collection...' : 'Curated essentials for the modern man'}
                    </p>
                </motion.div>
